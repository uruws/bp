...
var Transcriber = (function () {
    function Transcriber(credentialsPath, language, enableAutomaticPunctuation) {
    ...
    Transcriber.prototype._getAudioFromUrl = function (sourceFileurl, jobId) {
    ...
    ;
    Transcriber.prototype._convertAudio = function (sourceFilePath, jobId) {
    ...
    ;
    Transcriber.prototype._uploadToGoogleCloudStorage = function (wavPath, jobId) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
    ...
    Transcriber.prototype._removeFromGoogleCloudStorage = function (jobId) {
        var bucket = this.storage.bucket("video_captions");
        bucket.file(jobId + ".wav").delete();
    };
    Transcriber.prototype.generateSubs = function (audioUrl, jobId) {
        return __awaiter(this, void 0, void 0, function () {
