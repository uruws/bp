...
import { BigQuery, Query, QueryRowsResponse, SimpleQueryRowsCallback } from '.';
...
export declare type GetTablesResponse = [Table[], r.Response];
export interface GetTablesCallback {
    (err: Error | null, tables?: Table[] | null, nextQuery?: {} | null, apiResponse?: r.Response): void;
}
export declare type TableResponse = [Table, r.Response];
